...
counts = read.table("Multiplex_vs_CG.data.txt")
counts = counts[,-2]
metadata = read.table("Multiplex_vs_CG.metadata.txt",header=T,sep="\t")
...
write.table(test.wide,"Multiplex_vs_CG_wide_mat.txt",row.names=F,quote=F,sep="\t")
